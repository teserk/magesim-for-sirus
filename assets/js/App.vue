...
export default {
  ...
  computed: {
    ...
    waitBuffs() {
      ...
      if (this.isEquipped("trinket", this.items.ids.TRINKET_ABYSSAL_RUNE))
        buffs.push({id: constants.buffs.ELUSIVE_POWER, name: "Abyssal Rune"});
  ...
  methods: {
    ...
    itemConfig() {
      ...
      if (this.isSpecialItem(this.equipped.neck))
        this.config.neck = this.equipped.neck;
