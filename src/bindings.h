...
EMSCRIPTEN_BINDINGS(my_module) {
  ...
  emscripten::enum_<Race>("Race")
    ...
    .value("RACE_LIGHTFORGED", RACE_LIGHTFORGED)
    .value("RACE_ZANDALARI", RACE_ZANDALARI);

  emscripten::enum_<Neck>("Neck")
    .value("NECK_ALDORS_213", NECK_ALDORS_213)
    .value("NECK_SCRYERS_213", NECK_SCRYERS_213)
    .value("NECK_ALDORS_232", NECK_ALDORS_232)
    .value("NECK_SCRYERS_232", NECK_SCRYERS_232)
    .value("NECK_ALDORS_251", NECK_ALDORS_251)
    .value("NECK_SCRYERS_251", NECK_SCRYERS_251)
    .value("NECK_ALDORS_264", NECK_ALDORS_264)
    .value("NECK_SCRYERS_264", NECK_SCRYERS_264);
  ...
  emscripten::enum_<Trinket>("Trinket")
    ...
    .value("TRINKET_DYING_CURSE_HM", TRINKET_DYING_CURSE_HM)
    ...
    .value("TRINKET_NEVERMELTING_ICE_CRYSTAL", TRINKET_NEVERMELTING_ICE_CRYSTAL)
    .value("TRINKET_MISGUIDED_QUILL", TRINKET_MISGUIDED_QUILL)
    .value("TRINKET_PURIFIED_LUNAR_DUST", TRINKET_PURIFIED_LUNAR_DUST);
  ...
  emscripten::class_<Config>("Config")
    ...
    .property("icc_buff", &Config::icc_buff)
    ...
    .property("t4_2set", &Config::t4_2set)
    .property("t4_4set", &Config::t4_4set)
